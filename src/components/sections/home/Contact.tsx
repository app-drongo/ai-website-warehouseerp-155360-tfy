...
const DEFAULT_CONTACT = {
  ...
  mainDescription:
    "Get in touch with our warehouse management experts. We'll help you find the perfect ERP solution for your facility and provide a custom demo.",
  formTitle: 'Request a Demo',
  formDescription:
    "Tell us about your warehouse and we'll schedule a personalized demo within 24 hours.",
  submitButton: 'Request Demo',
  contactSectionTitle: 'Get Expert Help',
  method1Title: 'Sales Team',
  method1Description: 'Speak with warehouse experts',
  method1Contact: 'sales@warehousepro.com',
  method2Title: 'Call Sales',
  method2Description: 'Direct line to our team',
  method2Contact: '+1 (555) 789-0123',
  method3Title: 'Live Demo',
  method3Description: 'See WarehousePro in action',
  method3Contact: 'Available Mon-Fri',
  officesSectionTitle: 'Regional Offices',
  office1City: 'Chicago',
  office1Address: '1200 Logistics Blvd, Suite 300',
  office1Timezone: 'CST (UTC-6)',
  office2City: 'Los Angeles',
  office2Address: '800 Distribution Way, Floor 12',
  office2Timezone: 'PST (UTC-8)',
  office3City: 'Atlanta',
  office3Address: '450 Supply Chain Drive, Building B',
  office3Timezone: 'EST (UTC-5)',
  hoursTitle: 'Sales Hours',
  ...
  supportNote: '24/7 technical support included with all plans',
  nameLabel: 'Full Name *',
  ...
  messagePlaceholder:
    "Describe your current warehouse operations, number of locations, inventory volume, and any specific challenges you're facing...",
} as const;
