...
const DEFAULT_HERO = {
  badge: 'New: AI-Powered Warehouse Management',
  title: 'Transform your warehouse with',
  titleHighlight: 'WarehousePro ERP',
  description:
    'Streamline inventory, optimize workflows, and boost productivity with our comprehensive warehouse management ERP solution. Built for modern logistics operations.',
  features: [
  ...
  imageAlt: 'WarehousePro Dashboard',
  statsLabel1: 'Efficiency Boost',
  statsValue1: '40% Average',
  statsLabel2: 'ROI Timeline',
  statsValue2: '6 Months',
} as const;
