...
const DEFAULT_PRICING = {
  ...
  mainTitleHighlight: 'ERP Pricing',
  mainDescription:
    'Choose the perfect WarehousePro plan for your warehouse operations. Scale from small facilities to enterprise-wide deployments with transparent pricing.',
  billingMonthly: 'Monthly',
  billingAnnual: 'Annual',
  billingAnnualBadge: 'Save 20%',
  plan1Name: 'Starter',
  plan1Description: 'Perfect for small warehouses and getting started',
  plan1Price: '$99',
  plan1CTA: 'Start Free Trial',
  plan1CTAHref: '/signup',
  plan2Name: 'Professional',
  plan2Description: 'Best for growing warehouses and multi-location operations',
  plan2Price: '$299',
  plan2Period: '/month',
  ...
  plan3Description: 'For large warehouse networks with custom integrations',
  plan3Price: 'Custom',
  plan3Badge: 'Best Value',
  plan3CTA: 'Contact Sales',
  plan3CTAHref: '/contact',
  bottomTitle: 'Need custom warehouse solutions?',
  bottomDescription:
    'We offer tailored ERP solutions for complex warehouse operations, custom integrations with existing systems, and dedicated support for enterprise deployments.',
