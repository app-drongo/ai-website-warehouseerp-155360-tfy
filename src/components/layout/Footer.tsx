...
const DEFAULT_FOOTER = {
  ...
  companyDescription:
    'Streamline your warehouse operations with our comprehensive ERP solution. Trusted by logistics companies worldwide to optimize inventory, automate workflows, and boost efficiency.',
  contactEmail: 'hello@warehousepro.com',
  contactPhone: '+1 (555) 123-4567',
  contactAddress: '123 Logistics Blvd, Suite 200',
  ...
  madeWithText: 'with ❤️ for warehouse teams',
